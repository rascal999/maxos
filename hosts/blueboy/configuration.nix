...

{
  ...
  services.cron = {
    enable = true;
    systemCronJobs = [
      "0 20 * * *        root    ${pkgs.rsync}/bin/rsync -av --no-perms /var/lib/trilium admin@192.168.0.254:/volume1/k8s-syncthing-data/data/"
      "0 2 * * *         root    /home/user/git/maxos/scripts/build_vm_virtualbox_pipeline.sh"
