  ...
  xsession.windowManager.i3 = {
    ...
    config = {
      ...
      keybindings = lib.mkDefault {
        ...
        "Mod4+j" = "exec ${pkgs.alacritty}/bin/ualacritty -bg black -fg white -e ${pkgs.tmux}/bin/tmux new-session -e JIRA_NEW=1";
        ...
        "${mod}+h" = "exec ${pkgs.alacritty}/bin/ualacritty -bg black -fg white -e ${pkgs.tmux}/bin/tmux new-session -e TMPWORK=1";
        "${mod}+Shift+h" = "exec ${pkgs.alacritty}/bin/ualacritty -bg black -fg white -e ${pkgs.tmux}/bin/tmux new-session -e NOHISTFILE=1";
        "${mod}+j" = "exec ${pkgs.alacritty}/bin/ualacritty -bg black -fg white -e ${pkgs.tmux}/bin/tmux new-session -e JIRALASTTICKET=1";
        "${mod}+Shift+j" = "exec ${pkgs.alacritty}/bin/ualacritty -bg black -fg white -e ${pkgs.tmux}/bin/tmux new-session -e JIRATICKET=1";
        ...
        #"${mod}+r" = "exec ${pkgs.alacritty}/bin/ualacritty -bg black -fg white -e ${pkgs.tmux}/bin/tmux new-session -e REMOTEWORK=1";
        "--release ${mod}+s" = "exec /home/user/git/maxos/scripts/screenshot.sh";
        "${mod}+t" = "exec ${pkgs.alacritty}/bin/ualacritty -bg black -fg white -e ${pkgs.tmux}/bin/tmux";
        ...
        "${mod}+w" = "exec ${pkgs.alacritty}/bin/ualacritty -bg black -fg white -e ${pkgs.tmux}/bin/tmux new-session -e WEBSCAN=1";
